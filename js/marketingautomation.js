  ...
  render() {
    return (
      <div>
        ...
        <p>
          Market• Create a strategy that works and build an actionable marketing
          automation planng automation allows a company to build and develop
          customer relationships using automation tools that reduce manual
          intervention and employee-dependency. A marketing automation software
          would include many aspects like landing pages, lead nurturing
          programs, marketing workflows, list segmentation, social media
          automation, lead scoring, and CRM integration. With effective
          marketing automation in place, you just have to drive visitors to your
          business website, and automation will ensure that those visitors
          convert into sales-ready leads or even sales at times.{" "}
        </p>
        ...
        <ul>
          ...
          <li>
            Send personalized emails to connect with customers on a large scale
          </li>
          <li>
